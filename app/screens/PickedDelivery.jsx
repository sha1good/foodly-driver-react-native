...
import UndefinedOrder from "./UndefinedOrder";
...
const PickedDelivery = ({ navigation }) => {
  ...
  const pickOrder = async () => {
    ...
    const endpoint = "http://localhost:6002/api/orders/delivered/" + item._id;
    try {
        ...
        >
            ...
            >
              ...
              >
                <View>
                  ...
                  <MapText text={`📍 ${item.restaurantId.coords.address} `} />
                </View>
              </View>
          ...
          <View style={{ position: "absolute", zIndex: 0, top: 90, left: 10 }}>
            ...
            >
              ...
              >
                Order from {item.restaurantId.title} to
              </Text>
